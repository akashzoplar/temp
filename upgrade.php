...
echo "--------------------------------------------------------\n";
echo "WELCOME TO THE Inventory Manager UPGRADER! \n";
echo "--------------------------------------------------------\n\n";
...
if ((version_compare(phpversion(), $php_min_works, '>=')) && (version_compare(phpversion(), $php_max_wontwork, '<'))) {
    ...
    echo "This version of PHP (".phpversion().") is NOT compatible with Inventory Manager.\n";
    echo "Inventory Manager requires PHP versions between ".$php_min_works." and ".$php_max_wontwork.".\n";
...
echo "--------------------------------------------------------\n\n";
$backup = shell_exec('php artisan InventoryManager:backup');
echo '-- '.$backup."\n\n";
...
if ((strpos('git version', $git_version)) === false) {
    ...
    echo "Please note that this script will not download the latest Inventory Manager \n";
...
echo "your upgraded Inventory Manager!\n";
echo "--------------------------------------------------------\n\n";
