...
if [ -f /var/lib/InventoryManager/ssl/InventoryManager-ssl.crt -a -f /var/lib/InventoryManager/ssl/InventoryManager-ssl.key ]
then
  a2enmod ssl
else
  a2dismod ssl
...
chown -R docker:root /var/lib/InventoryManager/data/*
chown -R docker:root /var/lib/InventoryManager/dumps
chown -R docker:root /var/lib/InventoryManager/keys
