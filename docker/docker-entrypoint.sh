...
for dir in \
  ...
  'keys'
do
  [ ! -d "/var/lib/InventoryManager/$dir" ] && mkdir -p "/var/lib/InventoryManager/$dir"
done

# Sync /var/lib/InventoryManager (docker volume) with /var/www/html directory
ln -fs \
  "/var/lib/InventoryManager/data/private_uploads" "/var/www/html/storage/private_uploads"
ln -fs \
  "/var/lib/InventoryManager/data/uploads" "/var/www/html/public/uploads"
ln -fs \
  "/var/lib/InventoryManager/dumps" "/var/www/html/storage/app/backups"
ln -fs \
  "/var/lib/InventoryManager/keys/oauth-public.key" "/var/www/html/storage/oauth-public.key"
ln -fs \
  "/var/lib/InventoryManager/keys/oauth-private.key" "/var/www/html/storage/oauth-private.key"
...
chown -R www-data:www-data \
  /var/lib/InventoryManager/data \
  /var/lib/InventoryManager/dumps \
  /var/lib/InventoryManager/keys
