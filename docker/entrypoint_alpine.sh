...
#if [ ! -f /var/lib/InventoryManager/ssl/InventoryManager-ssl.crt -o ! -f /var/lib/InventoryManager/ssl/InventoryManager-ssl.key ]
#then
...
chown -R apache:root /var/lib/InventoryManager/data/*
chown -R apache:root /var/lib/InventoryManager/dumps
chown -R apache:root /var/lib/InventoryManager/keys
