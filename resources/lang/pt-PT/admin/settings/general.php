...
'ldap_location_help'             => 'O campo Ldap de localização deverá ser usado se <strong>uma OU não estiver a ser usada na "Base Bind DN".</strong> Deixe em branco se uma pesquisa por OU estiver a ser usada.',
    ...
    'load_remote_help_text'		=> 'Esta instalação do Inventory Manager pode carregar scripts do mundo exterior.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se preenchido, os utilizadores serão redirecionados para este URL depois de fecharem a sessão no InventoryManager. É particularmente útil para fechar corretamente a sessão do utilizador do fornecedor de autenticação.',
    ...
    'show_images_in_email_help'   => 'Desmarque esta caixa se a sua instalação do Inventory Manager estiver a correr através de uma VPN ou rede fechada e utilizadores fora da rede não conseguirem carregar as imagens desta instalação nos seus e-mails.',
    ...
    'InventoryManager_version'  			=> 'Versão Inventory Manager',
    'support_footer'            => 'Links de rodapé de suporte',
    'support_footer_help'       => 'Especifica quem vê os links de Suporte e Manual de utilizador do Inventory Manager',
    'version_footer'            => 'Versão no Rodapé ',
    'version_footer_help'       => 'Especifica quem vê o número de versão e compilação do InventoryManager-lT.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link para Inventory Manager em E-mails',
    'show_url_in_emails_help_text'      => 'Desmarque esta caixa se não deseja vincular novamente a sua instalação Inventory Manager em seus rodapés de e-mail. Útil se a maioria de seus usuários nunca logar.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Isto irá apagar códigos de barras em cache. Isto normalmente só deveria ser usado se as configurações do código de barras tivessem sido alteradas, ou se a URL do Inventory Manager tivesse sido alterada. Códigos de barras serão novamente gerados quando forem acedidos.',
