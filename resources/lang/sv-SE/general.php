...
return [
    ...
    'importing_help'        => 'Du kan importera tillgångar, tillbehör, licenser, komponenter, förbrukningsvaror och användare via CSV-fil. <br><br>CSV bör vara komma-avgränsad och formaterad med rubriker som matchar de i <a href="https://Inventory Manager.readme.io/docs/importing" target="_new">ta prov CSVs i dokumentationen</a>.',
    ...
    'webhook_test_msg'        => 'Hej! Ser ut som din :app integration med Inventory Manager fungerar!',
