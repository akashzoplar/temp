...
'ldap_location_help'             => 'LDAP platsfältet bör användas om <strong>ett OU inte används i Base Bind DN.</strong> Lämna detta tomt om en OU-sökning används.',
    ...
    'load_remote_help_text'		=> 'Denna Inventory Manager-installation kan ladda skript från omvärlden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Om en URL tillhandahålls här kommer användarna att omdirigeras till den här webbadressen efter att användaren loggat ut från Inventory Manager. Det här är användbart för att stänga användarsessionerna i din autentiseringsleverantör korrekt.',
    ...
    'show_images_in_email_help'   => 'Avmarkera den här rutan om din Inventory Manager-installation ligger bakom ett VPN eller ett stängt nätverk och användare utanför nätverket kan inte ladda bilder som visas från den här installationen i sina e-postmeddelanden.',
    'site_name'                 => 'Sidnamn',
    ...
    'InventoryManager_version'  			=> 'Inventory Manager-versionen',
    'support_footer'            => 'Stöd länkar i sidfot ',
    'support_footer_help'       => 'Ange vem som kan se länkarna till Inventory Manager Support info och användarmanual',
    'version_footer'            => 'Version i sidfot ',
    'version_footer_help'       => 'Specificera vilka som kan se Inventory Manager version och build nummer.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Länk till Inventory Manager i e-post',
    'show_url_in_emails_help_text'      => 'Avmarkera den här rutan om du inte vill länka tillbaka till din Inventory Manager-installation i dina e-postfoton. Användbart om de flesta av dina användare aldrig loggar in.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Detta kommer att försöka ta bort cachade streckkoder. Detta skulle normalt bara användas om dina streckkodsinställningar har ändrats, eller om din Inventory Manager-URL har ändrats. Streckkoder kommer att återskapas när de nås härnäst.',
    ...
    'label2_enable_help'      => 'Byt till den nya etikettmotorn. <b> Obs! Du måste spara den här inställningen innan du ställer in andra inställningar.</b>',
    'label2_template'         => 'Mall',
    'label2_template_help'    => 'Välj vilken mall som ska användas för etikettgenerering',
    'label2_title'            => 'Rubrik',
    'label2_title_help'       => 'Rubriken att visa på etiketter som stöder det',
    ...
    'help_asterisk_bold'    => 'Text inlagd som <code>**text**</code> kommer att visas som fet text',
