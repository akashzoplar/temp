...
return [
    ...
    'importing_help'        => 'アセット、アクセサリ、ライセンス、コンポーネント、消耗品、およびユーザーをCSVファイルからインポートできます。 <br><br>CSVは、ドキュメント <a href="https://Inventory Manager.readme.io/docs/importing" target="_new"></a> のサンプルCSVに一致するヘッダーでカンマ区切りでフォーマットする必要があります。',
    ...
    'webhook_test_msg'        => ':app とInventory Managerの連携がうまくいっているようです！',
