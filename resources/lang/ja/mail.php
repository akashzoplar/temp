...
return [
    ...
    'login_first_admin' => '以下の新しいログイン情報を使用して、Inventory Managerにログインします。',
    'login' => 'ログイン:',
    ...
    'supplier' => '仕入先',
    'tag' => 'タグ',
    'test_email' => 'Inventory Managerからのテストメール',
    'test_mail_text' => 'これはInventory Manager資産管理システムのテストです。あなたがこれを読めているなら、メール機能は動作しています:)',
    ...
    'your_credentials' => 'Inventory Manager クレデンシャル',
