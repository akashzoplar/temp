...
return [
    ...
    'importing_help'        => 'Puedes importar activos, accesorios, licencias, componentes, insumos y usuarios vía archivos CSV.<br> <br> El CSV debe estar delimitado por comas y formateado con encabezados que coincidan con aquellos definidos en los <a href="https://Inventory Manager.readme.io/docs/importing" target="_new"> CSVs de muestra en la documentación</a>.',
    ...
    'webhook_test_msg'        => '¡Parece que tu integración de :app con Inventory Manager está funcionando!',
