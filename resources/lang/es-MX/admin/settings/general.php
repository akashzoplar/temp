...
'ldap_location_help'             => 'El campo Ubicación de Ldap debe utilizarse si <strong>una OU no está siendo utilizada en el DN del enlace base.</strong> Deja este espacio en blanco si se utiliza una búsqueda OU.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Sí se especifica un URL, los usuarios serán redireccionados a este URL una vez que cierren sesión en InventoryManager-TI. Esto es útil para cerrar sesiones de usuario de su Authentication Provider de forma correcta.',
    ...
    'version_footer_help'       => 'Especificar quién ve la versión Inventory Manager y el número de compilación.',
