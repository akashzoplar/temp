...
return [
    ...
    'login_first_admin' => 'Συνδεθείτε στη νέα σας εγκατάσταση Inventory Manager χρησιμοποιώντας τα παρακάτω διαπιστευτήρια:',
    'login' => 'Σύνδεση:',
    ...
    'tag' => 'Ετικέτα',
    'test_email' => 'Έλεγχος email για Inventory Manager',
    'test_mail_text' => 'Πρόκειται για μια δοκιμή από το σύστημα διαχείρισης περιουσιακών στοιχείων της Inventory Manager. Αν το έχετε, το mail λειτουργεί :)',
    ...
    'your_credentials' => 'Τα διαπιστευτήρια σας Inventory Manager',
