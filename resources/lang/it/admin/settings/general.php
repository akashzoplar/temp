...
'ldap_location_help'             => 'Il campo Posizione LDAP deve essere usato se <strong>una OU non viene utilizzata nella Base Bind DN</strong> Lascia vuoto se viene usata la ricerca OU.',
    ...
    'load_remote_help_text'		=> 'Questa installazione di Inventory Manager può caricare script dal mondo esterno.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se qui viene indicato un URL, gli utenti verranno reindirizzato a questo URL dopo essere usciti da Inventory Manager. Questo è utile per chiudere correttamente le sessioni dell\'utente.',
    ...
    'show_images_in_email_help'   => 'Deseleziona questa casella se l\'installazione di Inventory Manager si trova dietro una rete VPN o chiusa e gli utenti esterni alla rete non saranno in grado di caricare le immagini fornite da questa installazione nelle loro e-mail.',
    'site_name'                 => 'Nome sito',
    ...
    'support_footer_help'       => 'Specificare chi vede i collegamenti alle informazioni sul supporto IT e su Inventory Manager',
    'version_footer'            => 'Versione a piè di pagina ',
    'version_footer_help'       => 'Specifica chi può vedere la versione di Inventory Manager e il numero di build.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Collegamento a Inventory Manager in posta elettronica',
    'show_url_in_emails_help_text'      => 'Deseleziona questa casella se non si desidera collegare nuovamente all\'installazione Inventory Manager nei piè di pagina di posta elettronica. Utile se la maggior parte dei tuoi utenti non entra mai in login.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Ciò eliminerà i codici a barre nella cache, utilizzato di solito se le impostazioni dei codici a barre sono cambiate, o se l\'URL di Inventory Manager è cambiato. I codici a barre saranno ri-generati alla prossima richiesta.',
