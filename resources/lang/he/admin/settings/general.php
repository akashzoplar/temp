...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'load_remote_help_text'		=> 'זה Inventory Manager להתקין יכול לטעון סקריפטים מהעולם החיצון.',
    ...
    'InventoryManager_version'  			=> 'Inventory Manager גירסה',
    ...
    'show_url_in_emails_help_text'      => 'בטל את הסימון בתיבה זו אם אינך רוצה לקשר חזרה את ההתקנה Inventory Manager שלך תחתונות הדוא"ל. שימושי אם רוב המשתמשים שלך לא מתחברים.',
    'text_pt'        => 'pt',
