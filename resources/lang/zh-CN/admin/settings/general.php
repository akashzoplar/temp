...
'ldap_location_help'             => '如果<strong>在 Base Bind DN 中没有使用OU</strong>，则LDAP 位置字段应当被使用；如果正在使用OU Search，请将此项留空。',
    ...
    'load_remote_help_text'		=> '允许Inventory Manager安装外部的加载脚本。',
    'login'                     => '登录尝试',
    'login_attempt'             => '登录尝试',
    'login_ip'                  => 'IP 地址',
    'login_success'             => '成功？',
    ...
    'login_remote_user_custom_logout_url_help' => '如果此处提供了URL，则在用户注销Inventory Manager后，用户将被重定向到此URL。这对于正确关闭身份验证提供程序的用户会话非常有用。',
    ...
    'show_images_in_email_help'   => '如果外部用户无法在邮件中通过你安装在VPN或内网的Inventory Manager加载图片，请取消此复选框。',
    'site_name'                 => '站点名称',
    'integrations'               => '集成',
    'slack'                     => 'Slack',
    ...
    'support_footer_help'       => '指定谁可以看到指向Inventory Manager支持信息和用户手册的链接',
    'version_footer'            => '页脚版本 ',
    'version_footer_help'       => '指定谁可以看到Inventory Manager版本和内部版本号。',
    'system'                    => '系统信息',
    'update'                    => '更新设置',
    'value'                     => '价值',
    'brand'                     => '品牌',
    ...
    'width_w'        => '宽',
    'height_h'        => '高',
    'show_url_in_emails'                => '链接到Inventory Manager在电子邮件',
    'show_url_in_emails_help_text'      => '如果您不希望链接回电子邮件页脚中的Inventory Manager安装，请取消选中此框。如果您的大多数用户从未登录，则很有用',
    'text_pt'        => '磅',
    ...
    'barcodes_help' => '这将尝试删除缓存条形码。 这通常只有在您的条码设置已经更改或您的Inventory Manager 链接已经更改时才使用。 下次访问时将重新生成条码。',
    ...
    'help_default_will_use' => '<code>:default</code> 将使用 <code>:setting_name</code>的值。 <br>请注意，条码的值必须符合相应的条码规范才能成功生成。请参阅 <a href="https://Inventory Manager.readme.io/docs/barcodes">文档 <i class="fa fa-external-link"></i></a> 了解更多详细信息。 ',
    'default'               => '默认',
    'none'                  => '无',
