...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'login_remote_user_custom_logout_url_help' => 'إذا تم توفير عنوان URL هنا، سيتم إعادة توجيه المستخدمين إلى عنوان URL هذا بعد تسجيل خروج المستخدم من Inventory Manager. هذا مفيد لإغلاق جلسات عمل المستخدم لموفر المصادقة بشكل صحيح.',
    ...
    'show_images_in_email_help'   => 'قم بإلغاء تحديد هذا المربع إذا كان تثبيت Inventory Manager وراء شبكة VPN أو شبكة مغلقة ولن يتمكن المستخدمون خارج الشبكة من تحميل الصور التي يخدمها هذا التثبيت في رسائل البريد الإلكتروني الخاصة بهم.',
    ...
    'InventoryManager_version'  			=> 'قنص-إيت الإصدار',
    ...
    'version_footer_help'       => 'حدد من سوف يرى إصدار Inventory Manager و رقم النسخة.',
    ...
    'width_w'        => 'ث',
    'height_h'        => 'ح',
    'show_url_in_emails'                => 'الرابط إلى Inventory Manager في رسائل البريد الإلكتروني',
    'show_url_in_emails_help_text'      => 'قم بإلغاء اختيار هذا المربع إذا كنت لا ترغب في الربط مرة أخرى إلى Inventory Manager في تذييل البريد الإلكتروني الخاص بك. تعد مفيدة إذا كان معظم المستخدمين لا يقومون بتسجيل الدخول. ',
    'text_pt'        => 'حزب العمال',
