...
return [
    ...
    'importing_help'        => 'Sie können Assets, Zubehör, Lizenzen, Komponenten, Verbrauchsmaterialien und Benutzer mittels einer CSV-Datei importieren. <br><br>Die CSV-Datei sollte kommagetrennt sein und eine Kopfzeile enthalten, die mit den <a href="https://Inventory Manager.readme.io/docs/importing" target="_new">Beispiel-CSVs aus der Dokumentation</a> übereinstimmen.',
    ...
    'webhook_test_msg'        => 'Oh hey! Sieht so aus, als ob Ihre :app Integration mit Inventory Manager funktioniert!',
