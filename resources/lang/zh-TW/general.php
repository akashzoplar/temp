...
return [
    ...
    'import'         	    => '匯入',
    'importing'         	=> '匯入中',
    'importing_help'        => '您可透過 CSV 格式檔案匯入資產、授權、配件、耗材以及使用者。<br><br> CSV檔案必須以逗號分格，並依照<a href="https://Inventory Manager.readme.io/docs/importing" target="_new">說明文件中的CSV範例</a>保留首部及格式。',
    ...
    'qty'		            => '數量',
    'quantity'		        => '數量',
    'quantity_minimum'      => '您有 :count 項目的數量低於或接近最小數量',
    ...
    'webhook_test_msg'        => '嗨！看起來您的 Inventory Manager 與 :app 的整合運作正常！',
    ...
    'hello_name'            => '你好, :name!',
    'unaccepted_profile_warning'   => '您有 :count 項目需要接受。點選這裡接受或拒絕它們',
    'start_date'            => '開始日期',
    'end_date'            => '結束日期',
