...
return [
    ...
    'login_first_admin' => '使用以下憑證登入新安裝的 Inventory Manager：',
    'login' => '登入',
    ...
    'supplier' => '供應商',
    'tag' => '標籤',
    'test_email' => 'Inventory Manager 測試電子郵件',
    'test_mail_text' => '這是一封 Inventory Manager 資產管理系統的測試電子郵件，如果您收到，表示郵件通知正常運作 :)',
    ...
    'welcome' => '歡迎您 :name',
    'welcome_to' => '歡迎來到 :web！',
    'your_credentials' => '您的 Inventory Manager 憑證',
