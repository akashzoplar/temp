...
'ldap_location_help'             => 'O campo de Localização do dap deve ser usado se <strong>um OU não estiver sendo usado no DNS de vinculação base.</strong> Deixe em branco se uma busca OU estiver sendo usada.',
    ...
    'load_remote_help_text'		=> 'Esta instalação do Inventory Manager pode carregar qualquer scripts do mundo.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se uma URL for inserida aqui, os usuários serão redirecionados para a essa URL após desconectarem do Inventory Manager. Isso pode ser útil para encerrar sessões com o seu provedor de Autenticação corretamente.',
    ...
    'show_images_in_email_help'   => 'Desmarque esta caixa se sua instalação de Inventory Manager está por trás de uma VPN ou rede fechada e usuários fora da rede não será capazes de carregar imagens, servidas a partir desta instalação em seus e-mails.',
    ...
    'InventoryManager_version'  			=> 'Versão do Inventory Manager',
    'support_footer'            => 'Links de rodapé de suporte ',
    'support_footer_help'       => 'Especifique quem vê os links para as informações de Suporte Inventory Manager e o Manual do Usuário',
    ...
    'barcodes_help' => 'Isto tentará apagar códigos de barras em cache. Isso normalmente só seria usado se as configurações do código de barras tivessem sido alteradas, ou se a URL do Inventory Manager tivesse sido alterada. Códigos de barras serão re-gerados quando acessados em seguida.',
