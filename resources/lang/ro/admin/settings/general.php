...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'load_remote_help_text'		=> 'Această instalare Inventory Manager poate încărca scripturi din lumea exterioară.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Dacă este furnizată aici o adresă URL, utilizatorii vor fi redirecționați către această adresă URL după ce utilizatorul va ieși din Inventory Manager. Acest lucru este util pentru a închide corect sesiunile de utilizator ale furnizorului dvs. de autentificare.',
    ...
    'show_images_in_email_help'   => 'Debifați această casetă dacă instalarea dvs. Inventory Manager se află în spatele unei rețele VPN sau închisă, iar utilizatorii din afara rețelei nu vor putea încărca imagini din această instalare în e-mailurile lor.',
    'site_name'                 => 'Nume site',
    ...
    'InventoryManager_version'  			=> 'Inventory Manager versiune',
    'support_footer'            => 'Legăturile de suport in subsol ',
    'support_footer_help'       => 'Specificați cine vede legăturile la informațiile despre asistența Inventory Manager și la Manualul utilizatorilor',
    'version_footer'            => 'Versiune în subsol ',
    'version_footer_help'       => 'Specificați cine vede versiunea Inventory Manager și numărul de construcție.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link către Inventory Manager în e-mailuri',
    'show_url_in_emails_help_text'      => 'Debifați această casetă dacă nu doriți să vă conectați la instalarea dvs. Inventory Manager în subsolul dvs. de e-mail. Utile dacă majoritatea utilizatorilor dvs. nu se înregistrează niciodată.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'This will attempt to delete cached barcodes. This would typically only be used if your barcode settings have changed, or if your Inventory Manager URL has changed. Barcodes will be re-generated when accessed next.',
