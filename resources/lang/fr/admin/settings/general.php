...
'ldap_location_help'             => 'Le champ "LDAP Localisation" ne doit être utilisé que si <strong>aucune OU n\'est définie dans le champ Bind de base DN</strong>. Laissez vide si une recherche par OU est utilisée.',
    ...
    'load_remote_help_text'		=> 'Cette installation Inventory Manager peut charger des scripts depuis le monde extérieur.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si une URL est spécifiée ici, les utilisateurs seront redirigés vers cette URL après la déconnexion de Inventory Manager. Ceci est utile pour fermer correctement les sessions utilisateur de votre fournisseur d\'authentification.',
    ...
    'show_images_in_email_help'   => 'Décocher cette case si votre installation de Inventory Manager est derrière un VPN ou un réseau fermé et que les utilisateurs en dehors du réseau ne peuvent pas charger les images servies depuis cette installation dans leurs courriels.',
    ...
    'support_footer_help'       => 'Spécifiez qui voit les liens vers les manuels de support utilisateur Inventory Manager',
    'version_footer'            => 'Version en pied de page ',
    'version_footer_help'       => 'Spécifiez qui peut voir la version de Inventory Manager.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Lien vers Inventory Manager dans les e-mails',
    'show_url_in_emails_help_text'      => 'Décochez cette case si vous ne souhaitez pas relier votre installation Inventory Manager à vos pieds de page. Utile si la plupart de vos utilisateurs ne se connectent jamais.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Cette opération essaiera de supprimer l\'ensemble des code-barres mis en cache. Cette opération n\'est utile que si les réglages de génération de code-barre ont été changés, ou si l\'URL de votre instance Inventory Manager a été modifiée. Les code-barres seront regénérés au prochain accès.',
