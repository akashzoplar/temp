...
return [
    ...
    'delete_confirm_no_undo' => 'Bạn có chắc chắn muốn xoá :item? Xoá xong là không thể phục hồi nhé.',
    'deleted'  				=> 'Đã xóa',
    ...
    'import'         	    => 'Nhập',
    'importing'         	=> 'Importing',
    'importing_help'        => 'Bạn có thể nhập nội dung, phụ kiện, giấy phép, linh kiện, vật tư tiêu hao và người dùng qua tệp CSV. <br> <br> CSV phải được phân cách bằng dấu phẩy và được định dạng với các tiêu đề khớp với các tiêu đề trong <a href="https://Inventory Manager.readme.io/docs/importing" target="_new"> CSV trong tài liệu mẫu </a>.',
    ...
    'webhook_test_msg'        => 'Oh hai! Looks like your :app integration with Inventory Manager is working!',
