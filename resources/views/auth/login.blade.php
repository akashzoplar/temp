        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="box login-box">
                        ...
                        <div class="login-box-body">
                            <div class="row">
                                ...
                                @if ($InventoryManagerSettings->login_note)
                                    <div class="col-md-12">
                                        <div class="alert alert-info">
                                            {!!  Helper::parseEscapedMarkedown($InventoryManagerSettings->login_note)  !!}
                                        </div>
                                    </div>
                                @endif
                            ...
                            @if (!config('app.require_saml') && $InventoryManagerSettings->saml_enabled)
                            <div class="row">
                        ...
                        <div class="box-footer">
                            ...
                            @if ($InventoryManagerSettings->custom_forgot_pass_url)
                                <div class="col-md-12 text-right" style="padding-top: 15px;">
                                    <a href="{{ $InventoryManagerSettings->custom_forgot_pass_url  }}" rel="noopener">{{ trans('auth/general.forgot_password')  }}</a>
                                </div>
                    ...
                    @if (($InventoryManagerSettings->google_login=='1') && ($InventoryManagerSettings->google_client_id!='') && ($InventoryManagerSettings->google_client_secret!=''))
