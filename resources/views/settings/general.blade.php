                   ...
                   <div class="form-group {{ $errors->has('default_eula_text') ? 'error' : '' }}">
                    ...
                    <div class="form-group {{ $errors->has('login_note') ? 'error' : '' }}">
                       ...
                       <div class="form-group {{ $errors->has('show_in_model_list') ? 'error' : '' }}">
                           ...
                           <div class="col-md-9">
                               <label class="form-control">
                               {{ Form::checkbox('show_in_model_list[]', 'image', old('show_in_model_list', $InventoryManagerSettings->modellistCheckedValue('image')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }} {{ trans('general.image') }}
                               </label>
                               <label class="form-control">
                               {{ Form::checkbox('show_in_model_list[]', 'category', old('show_in_model_list', $InventoryManagerSettings->modellistCheckedValue('category')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }} {{ trans('general.category') }}
                               </label>
                               <label class="form-control">
                               {{ Form::checkbox('show_in_model_list[]', 'manufacturer', old('show_in_model_list', $InventoryManagerSettings->modellistCheckedValue('manufacturer')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }}  {{ trans('general.manufacturer') }} </label>
                               <label class="form-control">
                               {{ Form::checkbox('show_in_model_list[]', 'model_number', old('show_in_model_list', $InventoryManagerSettings->modellistCheckedValue('model_number')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }} {{ trans('general.model_no') }}
                               </label>
                           </div>
                       </div>
