                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12" style="border-top: 0px;">
                        ...
                        <div class="form-group{{ $errors->has('webhook_botname') ? ' error' : '' }}">
                            ...
                            <div class="col-md-9">
                                    <input type="text" wire:model.lazy="webhook_botname" class='form-control' placeholder="InventoryManager-Bot" {{ old('webhook_botname', $webhook_botname)}}{{ Helper::isDemoMode() ? ' disabled' : ''}}>
