 ...
 * @param  {JSON} settings Insulated `window.InventoryManagerit.settings` object.
...
}(jQuery, window.InventoryManagerit.settings));
...
$(document).ready(function () {
    ...
    */
    ...
    // So a URL such as, http://Inventory Manager.local/hardware/2/#my_tab will
