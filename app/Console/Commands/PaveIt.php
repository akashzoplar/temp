...
class PaveIt extends Command
{
     ...
     * @var string
     */
    protected $signature = 'InventoryManager:pave  {--force : Skip the interactive yes/no prompt for confirmation}';
