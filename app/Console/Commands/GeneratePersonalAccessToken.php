...
class GeneratePersonalAccessToken extends Command
{
     ...
     * @var string
     */
    protected $signature = 'InventoryManager:make-api-key 
     ...
     * @var string
     */
    protected $description = 'This console command allows you to generate Personal API tokens to be used with the Inventory Manager JSON REST API on behalf of a user.';
