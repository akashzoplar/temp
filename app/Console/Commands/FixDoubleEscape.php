...
class FixDoubleEscape extends Command
{
     ...
     * @var string
     */
    protected $signature = 'InventoryManager:unescape';
     ...
     * @var string
     */
    protected $description = 'This should be run to fix some double-escaping issues from earlier versions of Inventory Manager.';
