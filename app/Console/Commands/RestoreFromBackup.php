...
class RestoreFromBackup extends Command
{
     ...
     * @var string
     */
    protected $signature = 'InventoryManager:restore 
     ...
     * @var string
     */
    protected $description = 'Restore from a previously created Inventory Manager backup file';
    ...
    public function handle()
    {
        ...
        if (strpos($sqlfiles[0], 'db-dumps') === false) {
            ...
            //older Inventory Manager installs don't have the db-dumps subdirectory component
        }
