...
use App\Models\InventoryManagerSCIMConfig;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('ArieTimmerman\Laravel\SCIMServer\SCIMConfig', InventoryManagerSCIMConfig::class); // this overrides the default SCIM configuration with our own
