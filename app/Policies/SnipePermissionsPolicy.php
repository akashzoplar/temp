...
/**
 * InventoryManagerPermissionsPolicy provides methods for handling the granular permissions used throughout Inventory Manager.
 ...
 * }
 */
abstract class InventoryManagerPermissionsPolicy
{
    /**
    ...
    public function before(User $user, $ability, $item)
    {
        ...
        if ($item instanceof \App\Models\InventoryManagerModel && ! Company::isCurrentUserHasAccess($item)) {
            return false;
        }
